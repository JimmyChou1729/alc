...
from alc_companion.publication_revisions import (
...
import alc_companion.publication_revisions as revision_module
...
def test_revision_adopts_unmanaged_browser_ancestor(tmp_path: Path):
    ...
    browser = FragmentRevision(
        ...
        provenance={**dict(base.provenance), "last_editor": "alc-render-browser"},
