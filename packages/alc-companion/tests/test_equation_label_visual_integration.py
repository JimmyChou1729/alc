...
import pytest
from ac_jobs import Awaiting, Paused, ResumeReason, RunStatus
...
import alc_companion.build as build_module
from alc_companion.generation_validation import CompanionContentError
from alc_companion.cli import _build_warnings, _resolve_source
...
def _visual_outcome(*, complete: bool, warnings: tuple[str, ...] = ()):
    return SimpleNamespace(
        ...
        diagnostics_document={
            "schema_version": "ac.document.equation_label_diagnostics.v1",
            "complete": complete,
        },
    )
...
def test_build_diagnostics_validator_rejects_replay_identity_drift() -> None:
    document = {
        "schema_version": "alc.companion.build_diagnostics.v1",
